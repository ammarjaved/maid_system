...
@section('content')
    ...
    <div class="container col-7">
        ...
        <div>
            ...
            <input id="agency_id" type="number" name="agency_id" disabled class="form-control" value="{{ old('agency_id', $maid->agency_id)}}">
        </div>

        <div>
            <label for="user_name">User Name</label>
            <span class="text-danger">@error('user_name'){{ $message }}@enderror</span>
            <input id="user_name" name="user_name" class="form-control" disabled value="{{old('user_name',$maid->user_name)}}">
        </div>

        <div>
            <label for="first_name">First Name</label>
            <span class="text-danger">@error('first_name'){{ $message }}@enderror</span>
            <input id="first_name" name="first_name" class="form-control" disabled value="{{old('first_name' ,$maid->first_name)}}">
        </div>

        <div>
            <label for="last_name">Last Name</label>
            <span class="text-danger">@error('last_name'){{ $message }}@enderror</span>
            <input id="last_name" name="last_name" class="form-control" disabled value="{{old('last_name' ,$maid->last_name)}}">
        </div>

        <div>
            <label for="full_name">Full Name</label>
            <span class="text-danger">@error('full_name'){{ $message }}@enderror</span>
            <input id="full_name" name="full_name" class="form-control" disabled value="{{old('full_name' ,$maid->full_name)}}">
        </div>
        ...
        <div>
            ...
            <input id="email" name="email" class="form-control" disabled value="{{old('email' ,$maid->email)}}">
        </div>

        <div>
            <label for="permanent_address">Agency pic number</label>
            <span class="text-danger">@error('permanent_address'){{ $message }}@enderror</span>
            <input id="permanent_address" name="permanent_address" disabled class="form-control" value="{{old('permanent_address' ,$maid->permanent_address)}}">
        </div>

        <div>
            <label for="date_of_birth">Date of Birth</label>
            <span class="text-danger">@error('date_of_birth'){{ $message }}@enderror</span>
            <input id="date_of_birth" type="date" name="date_of_birth" disabled class="form-control" value="{{old('date_of_birth' ,$maid->date_of_birth)}}">
        </div>
        ...
        <div>
            ...
            <input id="contact_number" disabled type="integer" name="contact_number" class="form-control" value="{{old('contact_number' ,$maid->contact_number)}}">
        </div>
        <div>
            <label for="emergency_contact">Emergency Contact</label>
            <span class="text-danger">@error('emergency_contact'){{ $message }}@enderror</span>
            <input id="emergency_contact" type="number" disabled name="emergency_contact" class="form-control" value="{{old('emergency_contact' ,$maid->emergency_contact)}}">
        </div>
        <div>
            <label for="education">Education</label>
            <span class="text-danger">@error('education'){{ $message }}@enderror</span>
            <input id="education" name="education" class="form-control" disabled value="{{old('education' ,$maid->education)}}">
        </div>
        <div>
            <label for="occupation">Occupation</label>
            <span class="text-danger">@error('occupation'){{ $message }}@enderror</span>
            <input id="occupation" name="occupation" class="form-control" disabled value="{{old('occupation' ,$maid->occupation)}}">
        </div>
        <div>
            <label for="skills">Skills</label>
            <span class="text-danger">@error('skills'){{ $message }}@enderror</span>
            <input id="skills" name="skills" class="form-control" disabled value="{{old('skills' ,$maid->skills)}}">
        </div>
        <div>
            <label for="religion">Religion</label>
            <span class="text-danger">@error('religion'){{ $message }}@enderror</span>
            <input id="religion" name="religion" class="form-control" disabled value="{{old('religion' ,$maid->religion)}}">
        </div>
        
        <div>
            <label for="passport_number">Passport Number</label>
            <span class="text-danger">@error('passport_number'){{ $message }}@enderror</span>
            <input id="passport_number" name="passport_number" disabled class="form-control" value="{{old('passport_number' ,$maid->passport_number)}}">
        </div>
        <div>
            <label for="passport_expiry">Passport Expiry</label>
            <span class="text-danger">@error('passport_expiry'){{ $message }}@enderror</span>
            <input id="passport_expiry" type="date" name="passport_expiry" disabled class="form-control" value="{{old('passport_expiry' ,$maid->passport_expiry)}}">
        </div>
        ...
        <div>
            ...
            <input id="visa_expiry_date" type="date" name="visa_expiry_date" disabled class="form-control" value="{{old('visa_expiry_date' ,$maid->visa_expiry_date)}}">
        </div>
        ...
        <div class="text-center">
            <a href="{{ route('maid.edit', $maid->id) }}"
                class="btn mt-3 btn-primary">Edit</a>
