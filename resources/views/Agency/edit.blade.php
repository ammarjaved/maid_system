    ...
    <div class="container col-9">
        ...
        @method('PATCH')
            ...
            <div class="col-6 mb-2 px-3">
                ...
                <input id="user_name" name="user_name" class="form-control" value="{{old('user_name',$agency->user_name)}}">
            </div>
    
            <div class="col-6 mb-2 px-3">
                <label for="agency_name">Agency Name</label>
                <span class="text-danger">@error('agency_name'){{ $message }}@enderror</span>
                <input id="agency_name" name="agency_name" class="form-control" value="{{old('agency_name',$agency->agency_name)}}">
            </div>
    
            <div class="col-6 mb-2 px-3 ">
                <label for="agency_email">Agency Email</label>
                <span class="text-danger">@error('agency_email'){{ $message }}@enderror</span>
                <input id="agency_email" name="agency_email" class="form-control" value="{{old('agency_email',$agency->agency_email)}}">
            </div>
    
            <div class="col-6 mb-2 px-3">
                <label for="agency_address">Agency Address</label>
                <span class="text-danger">@error('agency_address'){{ $message }}@enderror</span>
                <input id="agency_address" name="agency_address" class="form-control" value="{{old('agency_address',$agency->agency_address)}}">
            </div>
            ...
            <div class="col-6 mb-2 px-3">
                ...
                <input id="agency_contact_number" type="number" name="agency_contact_number" class="form-control" value="{{old('agency_contact_no',$agency->agency_contact_no)}}">
            </div>
    
            <div class="col-6 mb-2 px-3">
                <label for="agency_sos">Agency SOS</label>
                <span class="text-danger">@error('agency_sos'){{ $message }}@enderror</span>
                <input id="agency_sos" name="agency_sos" class="form-control" value="{{old('agency_sos',$agency->agency_sos)}}">
            </div>
    
            <div class="col-6 mb-2 px-3">
                <label for="agency_ssm">Agency SSM</label>
                <span class="text-danger">@error('agency_ssm'){{ $message }}@enderror</span>
                <input id="agency_ssm" name="agency_ssm" class="form-control" value="{{old('agency_ssm',$agency->agency_ssm)}}">
            </div>
    
            <div class="col-6 mb-2 px-3">
                <label for="agency_pic_number">Agency pic number</label>
                <span class="text-danger">@error('agency_pic_number'){{ $message }}@enderror</span>
                <input id="agency_pic_number" name="agency_pic_number" class="form-control" value="{{old('agency_pic_number',$agency->agency_pic_number)}}">
            </div>
            ...
            <div class="col-6 mb-2 px-3">
                ...
                <input id="agency_aps_license_number" name="agency_aps_license_number" class="form-control" value="{{old('agency_aps_license_number',$agency->agency_aps_license_number)}}">
            </div>
    
            <div class="col-6 mb-2 px-3">
                <label for="number_of_maids">Number of maids</label>
                <span class="text-danger">@error('number_of_maids'){{ $message }}@enderror</span>
                <input id="number_of_maids" name="number_of_maids" class="form-control" value="{{old('number_of_maids' ,$agency->number_of_maids)}}">
            </div>
