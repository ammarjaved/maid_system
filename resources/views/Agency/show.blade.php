    ...
    <div class="container col-9">
        <div class="card p-3 ">
            ...
            <div class="col-6 mb-2 px-3">
                ...
                <input id="agency_name" disabled name="agency_name" class="form-control" value="{{old('agency_name',$agency->agency_name)}}">
            </div>
    
            <div class="col-6 mb-2 px-3 ">
                <label for="agency_email">Agency Email</label>
                <span class="text-danger">@error('agency_email'){{ $message }}@enderror</span>
                <input id="agency_email" disabled name="agency_email" class="form-control" value="{{old('agency_email',$agency->agency_email)}}">
            </div>
    
            <div class="col-6 mb-2 px-3">
                <label for="agency_address">Agency Address</label>
                <span class="text-danger">@error('agency_address'){{ $message }}@enderror</span>
                <input id="agency_address" disabled name="agency_address" class="form-control" value="{{old('agency_address',$agency->agency_address)}}">
            </div>
            ...
            <div class="col-6 mb-2 px-3">
                ...
                <input id="agency_contact_number" disabled type="number" name="agency_contact_number" class="form-control" value="{{old('agency_contact_no',$agency->agency_contact_no)}}">
            </div>
    
            <div class="col-6 mb-2 px-3">
                <label for="agency_sos">Agency SOS</label>
                <span class="text-danger">@error('agency_sos'){{ $message }}@enderror</span>
                <input id="agency_sos" disabled name="agency_sos" class="form-control" value="{{old('agency_sos',$agency->agency_sos)}}">
            </div>
    
            <div class="col-6 mb-2 px-3">
                <label for="agency_ssm">Agency SSM</label>
                <span class="text-danger">@error('agency_ssm'){{ $message }}@enderror</span>
                <input id="agency_ssm" disabled name="agency_ssm" class="form-control" value="{{old('agency_ssm',$agency->agency_ssm)}}">
            </div>
    
            <div class="col-6 mb-2 px-3">
                <label for="agency_pic_number">Agency pic number</label>
                <span class="text-danger">@error('agency_pic_number'){{ $message }}@enderror</span>
                <input id="agency_pic_number" disabled name="agency_pic_number" class="form-control" value="{{old('agency_pic_number',$agency->agency_pic_number)}}">
            </div>
            ...
            <div class="col-6 mb-2 px-3">
                ...
                <input id="agency_aps_license_number" disabled name="agency_aps_license_number" class="form-control" value="{{old('agency_aps_license_number',$agency->agency_aps_license_number)}}">
            </div>
    
            <div class="col-6 mb-2 px-3">
                <label for="number_of_maids">Number of maids</label>
                <span class="text-danger">@error('number_of_maids'){{ $message }}@enderror</span>
                <input id="number_of_maids" disabled name="number_of_maids" class="form-control" value="{{old('number_of_maids' ,$agency->number_of_maids)}}">
            </div>
